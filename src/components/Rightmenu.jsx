  ...
  return (
   <>
    <div className="calendar-container">
        ...
        <div className='leftarrow-div'><img src={leftarrow} alt="Arrow the content in left side" className='leftarrow'/></div>
        <h1 className='month-style'>March</h1>
        <div className='rightarrow-div'><img src={rightarrow} alt="Arrow the content in Right side"  className='rightarrow'/></div>
    ...
    upcomingdata.map((updata,index)=>{
        ...
        return (
            ...
            <div style={{ marginTop: '-28px' }}><button className='details'>Details</button></div>
            </div>
            );
        })
    }
    ...
    <div style={{ marginTop: '50px',marginLeft: '10px'}}>
        ...
        activitydata.map((actdata,index)=>{
            return <div className='up-menu-act'>
                        <div><img src={actdata.images}/></div>
                        <div>
    ...
    <div style={{ marginTop: '50px',marginLeft: '10px'}}>
        ...
        hiringdata.map((data,index)=>{
            return  <div className='up-menu1'>
                        ...
                        <div><button className='details1'>Details</button></div>
                    </div>
            })
        }
    </div>
